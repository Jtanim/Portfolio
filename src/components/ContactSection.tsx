...
export const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-[#07090E] border-b border-white/[0.08] relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-5">
            ...
            {/* Availability Banner */}
            <div className="arch-panel p-6 shadow-xl space-y-3">
            ...
            <div className="space-y-2.5">
              ...
              <a
                ...
                className="p-4 rounded-xl bg-[#0D111A] hover:bg-[#141A26] border border-white/[0.08] hover:border-cyan-500/40 transition-all flex items-center justify-between group"
              >
              ...
              <button
                ...
                className="w-full p-4 rounded-xl bg-[#0D111A] hover:bg-[#141A26] border border-emerald-500/30 hover:border-emerald-400 transition-all flex items-center justify-between text-left group cursor-pointer"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-[11px] font-mono text-emerald-400 font-semibold">Direct WhatsApp</div>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="p-4 rounded-xl bg-[#0D111A] hover:bg-[#141A26] border border-white/[0.08] hover:border-blue-500/40 transition-all flex items-center justify-between group"
              >
                <div className="flex items-center gap-3">
          ...
          <div className="lg:col-span-7">
            <div className="arch-panel p-6 sm:p-8 shadow-xl">
              ...
              {submitted ? (
                <div className="p-8 rounded-xl bg-emerald-950/40 border border-emerald-500/30 text-center space-y-3 animate-fadeIn">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl bg-slate-800 text-slate-200 text-xs font-medium hover:bg-slate-700 transition-all cursor-pointer"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 bg-[#090D15] border border-white/[0.08] rounded-xl text-xs text-white placeholder-slate-500 focus:outline-none focus:border-cyan-400 transition-colors"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 bg-[#090D15] border border-white/[0.08] rounded-xl text-xs text-white placeholder-slate-500 focus:outline-none focus:border-cyan-400 transition-colors font-mono"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <select
                      ...
                      className="w-full px-3.5 py-2.5 bg-[#090D15] border border-white/[0.08] rounded-xl text-xs text-white focus:outline-none focus:border-cyan-400 transition-colors"
                    >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      className="w-full px-3.5 py-2.5 bg-[#090D15] border border-white/[0.08] rounded-xl text-xs text-white placeholder-slate-500 focus:outline-none focus:border-cyan-400 transition-colors resize-none"
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 px-6 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-slate-950 font-bold text-xs uppercase tracking-wider transition-all shadow-lg shadow-cyan-500/20 flex items-center justify-center gap-2 active:scale-95 cursor-pointer"
                  >
