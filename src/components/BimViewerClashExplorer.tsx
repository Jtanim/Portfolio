...
export const BimViewerClashExplorer: React.FC = () => {
  ...
  return (
    <section id="bim-explorer" className="py-20 bg-[#0A0E18] border-b border-slate-800/80 relative">
      
      {/* Background Ambient Lighting */}
      <div className="absolute top-1/3 left-10 w-[450px] h-[320px] bg-cyan-500/5 blur-[130px] pointer-events-none rounded-full" />
      <div className="absolute bottom-10 right-10 w-[450px] h-[320px] bg-emerald-500/5 blur-[130px] pointer-events-none rounded-full" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6 pb-6 border-b border-slate-800">
          <div>
            ...
            <p className="text-slate-300 text-sm sm:text-base mt-2 max-w-2xl font-normal">
              Inspect and resolve real 3D spatial collisions before fabrication: mechanical duct penetrations, wet/dry shaft overlaps, and ceiling cove fire line clearances.
            </p>
          </div>
          
          <div className="flex items-center gap-2 font-mono text-xs text-slate-300 bg-slate-900/80 px-3 py-2 rounded-xl border border-slate-700/80">
            <span className="px-2.5 py-1 bg-cyan-500/20 text-cyan-300 rounded-lg font-semibold border border-cyan-500/30">
              Three.js 3D Lab
            </span>
            <span className="text-slate-400">
              Tolerance: 0mm Hard Collision
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="rounded-2xl bg-slate-900/80 border border-slate-700/80 p-5 sm:p-6 shadow-xl backdrop-blur-md">
              ...
              <div className="flex items-center justify-between pb-4 border-b border-slate-800">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">Orbit 3D mesh • Test real-time rerouting</p>
                  </div>
                </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="rounded-2xl bg-slate-900/80 border border-slate-700/80 p-5 sm:p-6 shadow-xl backdrop-blur-md space-y-4">
              ...
              <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-3">
                ...
                <div className="pt-2 text-xs text-slate-400">
                  <strong className="text-slate-200">Outcome:</strong> {selectedLod.useCase}
                </div>
              </div>
            </div>
